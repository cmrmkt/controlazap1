...
-- 1. Fix is_admin() function to avoid circular dependency
...
-- 2. Add service role policies for profiles (allows Perfect Pay user creation)
...
-- 3. Add service role policies for subscriptions  
...
-- 4. Create fallback policy for Perfect Pay users with assinaturaid = 'active'
...
-- 5. Allow Perfect Pay users to update their own profiles
...
-- 6. Grant necessary permissions to service_role for authentication flows
